    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i =0; i<earthquakeArray.length(); i++){
                ...
                String mag =  String.valueOf(currentEarthquake.getDouble("mag"));
                String location = currentEarthquake.getString("place");
                long date = currentEarthquake.getLong("time");

                String dateToDisplay =  new SimpleDateFormat("MMM DD,yyyy").format(date);

                String timeToDisplay = new SimpleDateFormat("hh:mm a").format(date);

                earthquakes.add(new Earthquake(dateToDisplay,mag,location,timeToDisplay,url));
